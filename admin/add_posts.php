...
<head>
   ...
   <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Lato:wght@100;400&family=Open+Sans:wght@300;400;700&display=swap" rel="stylesheet">
...
<body>
   ...
   <section class="post-editor">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <input type="text" name="title" maxlength="200" required placeholder="add post title" class="box">
